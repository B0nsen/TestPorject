  ...
  return (
    <div className="w-full flex items-center gap-[8px]">
      ...
      <div className="flex flex-col gap-[9px]">
        ...
        <span className="sm:flex hidden text-[14px] leading-[20px] align-middle opacity-60">
      ...
      <button
        onClick={onDelete}
        type="button"
        className="shrink-0 text-main/60 ml-auto rounded-[20px] border border-main/60 px-[24px] py-[6px] cursor-pointer
