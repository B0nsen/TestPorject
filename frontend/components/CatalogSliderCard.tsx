...
export default function CatalogSliderCard({
  ...
  return (
    <Link
      href={href}
      className="flex flex-col w-full shrink-0 gap-[10px] group/card cursor-pointer"
    >
      <div
        className="
        ...
        transition-colors duration-200 group-hover/card:border-[#3f4d6d] bg-img 
      "
      >
        <Image
          src={imageSrc}
          alt={title}
          fill
          className="object-contain object-center transition-transform duration-300 group-hover/card:scale-105 p-[10px]"
