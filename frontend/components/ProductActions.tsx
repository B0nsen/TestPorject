        ...
        >
            <div className="flex flex-col gap-[10px]">
                ...
                <div className="flex items-center gap-2 text-[#10141C] my-0.5 cursor-pointer group transition-colors duration-150 hover:text-[#4C7DFF]">
                    <svg
                        className="w-[16px] h-[14px] shrink-0 transition-transform duration-200 group-hover:translate-x-0.5"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2.2"
                        viewBox="0 0 24 24"
                    >
                        <path
                            ...
                            d="M8.25 18.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM19.5 18.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"
                        />
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M2.25 5.25h11.25v10.5H2.25zM13.5 7.5h6.25l3 4.5v3.75h-9.25V7.5Z"
                        />
                    </svg>
                    <span className="text-[14px] leading-[20px] font-normal select-none">
                        Delivery to{" "}
                        <span className="font-bold group-hover:underline">
                            {product.actionsSection?.shippingLocation || "Constanta"}
                        </span>
                    </span>
                </div>
